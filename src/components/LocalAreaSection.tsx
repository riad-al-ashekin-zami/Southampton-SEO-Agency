...
import { LOCAL_AREAS } from '../data/seoData';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {LOCAL_AREAS.map((area, idx) => (
            ...
            >
              ...
              <div className="pt-3 mt-4 border-t border-gray-200/60 text-[11px] text-gray-500 font-medium">
                • Geo-targeted Local SEO signals
              </div>
            </div>
          ))}
        </div>
